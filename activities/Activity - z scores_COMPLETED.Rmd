...
**The time series of daily calls shows a steady rise in the number of calls in the beginning of 2022. rising between January and April. After peaking in October of 2022 with over 20 calls, the calls begin a gradual decline. There is still fluctuation as the numbers decline, but it's obvious that the graph decreases to the right as it moves into 2023.**
...
**The unusual days highlight the extreme outliers. My previous observation focused on a peak in October and a fall entering 2023, however, it's more obvious on this graph that the decline starts earlier.The decline begins in decline begins in August/September, instead of October. **
...
**The days where the highest and lowest outliers were signal that these situations were beyond what's normally expected on a given, average, day. For example, the Tuesday in October with 23 calls is considered extremely unusual, when it's compared to the average on a normal Tuesday. This shows a high surge where it's possible that a certain event or situation resulted in a large number of calls.**
...
**Data analysis of daily 911 overdose calls in Baltimore County shows several days of the year that were extremely above and below the average number of calls per day. These outlier days, marked by an extreme high in October, mark potential situations that cause for a story: what happened on these days?**

**October 10, 2004, had an extreme high of 23 calls for overdoses in one day, which is extremely abnormal compared to other data in Baltimore County. There are several other days that match this heightened call number, with July 14, 2022 at 21 calls and July 22, 2022 also at 21 calls.**

**My next steps would be reaching out to the Baltimore County EMS team to inquire about what happened on these days, and local hospitals, to see if they're aware of any situations.**
