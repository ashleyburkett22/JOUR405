...
**Your answer**:
An example of data that might not come up normally distributed is lifespan over the past few hundred years. This may be skewed because people live longer now than they did in the 1900s because of modern medicine. This would be skewed to the right since people live longer. Another example could be test scores for a really hard test, that make more people score lower. The distribution would be more to the left htan middle. 

A reporter working on a story where the data isn't normally distributed should state that, and explain why. The statistical measure that they should avoid is the average, because outliers skew the data. 
...
Maryland is on the higher end of aces with 223, placing it in the 17th place, in the 95% percentile. Only 5% of teams scored better than Maryland. This means that Maryland has a large amount of aces in their games, compares to other teams This makes sense because Maryland volleyball is pretty good, and has a high record. Teams with a better record tend to be towards the higher end of this list. 
...
**Answer**:
The distribution is skewed to the right. The mean is 13 car thefts per month. The range of data to the left of the mean shows that about 10 incidents happen per month. The range of data to the right of the mean shows that 15 incidents happen per month. 2/3 of the data occurs on either size of the standard deviation. 
